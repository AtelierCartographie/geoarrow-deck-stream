 ...
 * ```
 */
export function createScatterplotLayerProps(data: BinaryPointData): BinaryScatterplotLayerProps {
  return {
    data: {
      length: data.length,
      attributes: {
 ...
 * ```
 */
export function createPathLayerProps(data: BinaryPathData): BinaryPathLayerProps {
  return {
    data: {
      length: data.length,
 ...
 * ```
 */
export function createSolidPolygonLayerProps(data: BinaryPolygonData): BinaryPolygonLayerProps {
...
export function createAttributesFromTable(
  data: BinaryPathData,
  attributeTable: Record<string, Float32Array | Float64Array | Int32Array | Uint32Array>
